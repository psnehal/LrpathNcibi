...
public class LRPathNowResourceTest {
	...
	@Test
	public void testPerformResourceAction() throws REXPMismatchException {
		String rServeAddress = "localhost";
		int rServePort = 6311;
	...
	private LRPathArguments createLRPathArguments() {
		...
		double[] readcounts = { 0.414580082, -0.176934427, 0.01006101 };
		data.setGeneids(geneids);
		data.setSigvals(sigvals);
		data.setDirection(direction);
		data.setMing(1);
		data.setReadcount(readcounts);
		return data;
	}
